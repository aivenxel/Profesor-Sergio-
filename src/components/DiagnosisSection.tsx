    ...
    <section id="diagnosis" className="relative py-24 bg-brand-blanc overflow-hidden px-6 sm:px-12 lg:px-20 border-b border-brand-ivoire">
      ...
      <div className="max-w-5xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-8">
          ...
          {/* Solution Callout (H3) */}
          <div className="lg:col-span-6 bg-[#001a3a] text-white p-8 sm:p-10 rounded-2xl text-left flex flex-col justify-between space-y-6 shadow-2xl relative overflow-hidden border-2 border-brand-or/40">
            <div className="absolute top-0 right-0 w-40 h-40 bg-brand-ciel/15 rounded-full translate-x-12 -translate-y-12 blur-2xl pointer-events-none" />
            
            <div className="space-y-4 z-10">
              <span className="font-mono text-xs uppercase tracking-[0.2em] text-brand-or font-extrabold flex items-center gap-2 bg-brand-or/20 px-3.5 py-1.5 rounded-full border border-brand-or/50 w-max">
                <Sparkles className="w-4 h-4 text-brand-or shrink-0" /> PROPÓSITO CENTRAL
              </span>
              <h3 className="font-serif text-2xl sm:text-3xl md:text-4xl font-normal leading-tight text-white">
                ...
                <span className="italic text-amber-300 font-semibold drop-shadow-xs">Vienes a construir una voz más segura en francés.</span>
              </h3>
            </div>
            
            <p className="font-sans text-sm sm:text-base text-white font-normal leading-relaxed z-10 pt-4 border-t border-white/20">
